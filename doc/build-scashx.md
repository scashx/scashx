...
ScashX (s/atoshi/cashx) is a fork of Bitcoin Core which adds a new chain option to restore home computer mining.
...
Download the latest version of ScashX and checkout the version you intend to build. If you want to build a specific version, you can replace `main` with the version tag.

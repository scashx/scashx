...
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/scashx.conf}
...
then
  ...
  echo -e "To safely generate a scashx.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example scashx.conf file in share/examples/'
...
##
## scashx.conf configuration file.
## Generated by contrib/devtools/gen-scashx-conf.sh.
##
